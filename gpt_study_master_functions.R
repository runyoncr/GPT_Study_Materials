...
hey_openai <- function(gpt_model = NA, two_step = FALSE, 
    ...
    num1 <- as.numeric(gsub("[^0-9.]", "", answer1))
    ...
    if(two_step == TRUE){
      ...
      num2 <- as.numeric(gsub("[^0-9.]", "", answer2))
...
hey_anthropic <- function(gpt_model = NA, two_step = FALSE, 
                          temp1 = 1, temp2 = NA, prompt1 = NA, prompt2 = NA){
...
hey_google <- function(gpt_model = NA, two_step = FALSE,
                       temp1 = 1, temp2 = NA, prompt1 = NA, prompt2 = NA){
    ...
    numbers <- gregexpr("[0-9]+", final_output1)
    numeric_values <- as.numeric(unlist(regmatches(final_output1, numbers)))
    num1 <- numeric_values[length(numeric_values)]
    ...
    if(two_step == TRUE){
      ...
      numbers <- gregexpr("[0-9]+", final_output2)
      numeric_values <- as.numeric(unlist(regmatches(final_output2, numbers)))
      num2 <- numeric_values[length(numeric_values)]
